...
파일다운로드 : https://drive.google.com/file/d/1jNjJ6RFdqxy3qomD1dMbSFovy_aav5Dy/view?usp=sharing
...
(2)
>한국어 교육에 종사하는 지인의 요청으로 API를 활용해 만들어 본 프로그램이고 업무의 자동화를 위하여 완성

(3)
>첫 실행 프로그램. 최대한 모든 환경에서 실행 가능하도록 최종적으로 exe형식의 파일로 완성했다.
